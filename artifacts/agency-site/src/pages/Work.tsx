...
export default function Work() {
  return <div className="min-h-screen bg-[#0a0b10] text-white">
    ...
    <Nav /><main className="pt-32 md:pt-44">
      ...
      <section className="border-t border-white/10 bg-[#11121a] py-16 md:py-24"><div className="page-gutter flex flex-col justify-between gap-8 md:flex-row md:items-center"><div><p className="text-xs uppercase tracking-[.2em] text-[#a99bff]">Planning a website?</p><h2 className="mt-4 font-display text-4xl font-semibold tracking-tight md:text-5xl">Tell us what your business needs.</h2></div><a href="/contact" className="inline-flex w-fit items-center gap-3 rounded-lg bg-[#765EFF] px-7 py-4 text-sm font-semibold text-white hover:bg-[#8b77ff]">Start a project <ArrowUpRight size={18} /></a></div></section>
    </main><Footer />
  </div>;
}
